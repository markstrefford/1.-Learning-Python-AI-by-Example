...
Using Wikipedia Artificial Intelligence content to create a model that we can query using natural language
to get rich information and responses from.


"""

# Imports
from crawler.crawl_wikipedia import crawl_wikipedia
